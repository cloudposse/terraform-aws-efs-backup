...
module "efs_backup" {
  ...
  efs_mount_target_id                = "${data.aws_efs_mount_target.default.mount_target_id}"
  efs_host                           = "${data.aws_efs_mount_target.default.ip_address}"
...
| efs_host                           |``              | DNS name of Elastic File System or IP address of Elastic File System                | Yes      |
